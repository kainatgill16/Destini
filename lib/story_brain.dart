...
class StoryBrain {
  List<Story> storyData = [
    ...
    Story(
        ...
        choice1: 'I love Elton John! Hand him the cassette tape.',
        choice2: 'It\'s him or me! You take the knife and stab him.'),
    Story(storyTitle: '3', choice1: 'Restart', choice2: ''),
    Story(storyTitle: '4', choice1: 'Restart', choice2: ''),
    Story(storyTitle: '5', choice1: 'Restart', choice2: ''),
  ];
  ...
  nextStory(int userChoice) {
    print("storyData.length ${storyData.length}");
    print("story number ${storyNumber}");
